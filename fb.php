...
if(isset($accessToken)){
    ...
    $fbLoginBttn = '<a href="'.htmlspecialchars($loginURL).'">Signin with Facebook</a>';
}
?>
...
<body>
<div class="container"><!-- Display login button / Facebook profile information -->
    <div class="fb-box"><?php echo $fbLoginBttn; ?></div>
</div>
</body>
</html>